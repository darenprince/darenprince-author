...
| `image-index.html`           | Internal image manifest viewer with searchable descriptions, closeable image modal, mobile column selector (1–4), pinch-to-zoom sizing, and copy-only URL actions | `js/image-index.js`, `scss/components/_viewer.scss`.                                                                                                                       |
