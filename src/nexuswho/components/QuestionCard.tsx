      ...
      <div className="mt-6 grid gap-3">
        {ANSWER_LABELS.map((label, index) => (
          <motion.button
            ...
            className="flex items-center justify-between rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 text-left text-sm font-medium text-slate-100 transition hover:border-emerald-400/40 hover:bg-emerald-500/10"
          >
            <span>{label}</span>
