...
- `style-guide.html` + `STYLE_GUIDE.md` – Independent visual style guide + implementation standards.
- `assets/styles.css` – App styling and responsive layout.
- `assets/app.js` / `assets/data.js` – Rendering, Iconify-driven card icons, and interactive filtering.
...
- Icon runtime is loaded from: `https://code.iconify.design/3/3.1.1/iconify.min.js`.
- Icons are configured at the data layer (`assets/data.js`) using Material Design icon names.
- UI rendering in `assets/app.js` converts those icon names into card title icons.
