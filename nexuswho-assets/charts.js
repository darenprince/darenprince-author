...
function Zo(i, t, e, s) {
  ...
  for (l = t + 1; l <= e; ++l) {
    ...
    ;(c.skip || c.stop
      ? a.skip ||
        ((s = !1), o.push({ start: t % n, end: (l - 1) % n, loop: s }), (t = r = c.stop ? l : null))
      : ((r = l), a.skip && (t = l)),
      (a = c))
  }
 ...
 */ class nr {
  ...
  _notify(t, e, s, n) {
    const o = e.listeners[n],
      r = e.duration
    o.forEach((a) =>
      a({ chart: t, initial: e.initial, numSteps: r, currentStep: Math.min(s - e.start, r) })
    )
  }
  _refresh() {
    this._request ||
...
class Dt {
  ...
  parsePrimitiveData(t, e, s, n) {
    ...
    let u, f, g
    for (u = 0, f = n; u < f; ++u)
      ((g = u + s), (d[u] = { [a]: h || o.parse(c[g], g), [l]: r.parse(e[g], g) }))
    return d
  }
  parseArrayData(t, e, s, n) {
    ...
    let l, c, h, d
    for (l = 0, c = n; l < c; ++l)
      ((h = l + s), (d = e[h]), (a[l] = { x: o.parse(d[0], h), y: r.parse(d[1], h) }))
    return a
  }
...
function yr(i, t, e, s) {
  ...
  let o, r
  return (
    L(n) ? ((o = t.min * e.categoryPercentage), (r = e.barPercentage)) : ((o = n * s), (r = 1)),
      ...
      if (l) {
        const { vScale: d } = n._cachedMeta,
          ...
          f = u
            .slice(0, h.lo + 1)
            .reverse()
            .findIndex((p) => !L(p[d.axis]))
        h.lo -= Math.max(0, f)
        const g = u.slice(h.hi).findIndex((p) => !L(p[d.axis]))
        h.hi += Math.max(0, g)
      }
      return h
    }
...
function Va(i, t, e, s) {
  ...
  for (l && ((f = n[x(0)]), i.moveTo(f.x, f.y)), u = 0; u <= a; ++u) {
    ...
    const v = f.x,
      ...
      S = v | 0
    ;(S === g
      ? (_ < p ? (p = _) : _ > m && (m = _), (h = (d * h + v) / ++d))
      : (y(), i.lineTo(v, _), (g = S), (d = 0), (p = m = _)),
      (b = _))
  }
  y()
}
...
function pl(i, t, e, s) {
  ...
  if (o === 'x' || o === 'y') {
    let l, c, h, d
    ;(o === 'x'
      ? ((l = r), (c = n.top), (h = a), (d = n.bottom))
      : ((l = n.left), (c = r), (h = n.right), (d = a)),
      i.beginPath(),
      e &&
        ((l = Math.max(l, e.left)),
    ...
    return (
      this.legendItems.forEach((m, b) => {
        ...
        ;(b > 0 &&
          ...
          (l[b] = { left: g, top: f, col: p, width: x, height: y }),
          (u = Math.max(u, x)),
          (f += y + a))
      }),
      (d += u),
  ...
  getCaretPosition(t, e, s) {
    ...
    return (
      o === 'center'
        ? ((v = f + p / 2),
          n === 'left'
            ? ((m = u), (b = m - r), (y = v + r), (_ = v - r))
            : ((m = u + g), (b = m + r), (y = v - r), (_ = v + r)),
          (x = m))
        : (n === 'left'
            ? (b = u + Math.max(l, h) + r)
            : n === 'right'
              ...
              : (b = this.caretX),
          o === 'top'
            ? ((y = f), (v = y - r), (m = b - r), (x = b + r))
            : ((y = f + p), (v = y + r), (m = b + r), (x = b - r)),
          (_ = y)),
