...
| DeveloperConsole.jsx | Canonical console shell | Remove runtime sidebar injection; establish explicit composition | Archaeology complete |
| DeveloperConsoleMVP.jsx | Developer Console / workspace | Preserve existing console functionality; compare history before rename/removal | Archaeology complete |
