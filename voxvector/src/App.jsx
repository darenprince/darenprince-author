        ...
        <section id="product" className="relative overflow-hidden border-b border-white/[0.07]">
          ...
          <div className="relative mx-auto grid max-w-[1440px] items-center gap-16 px-5 py-20 sm:py-24 lg:grid-cols-[0.82fr_1.18fr] lg:px-10 lg:py-28 xl:gap-24">
            <div>
              ...
              <Reveal delay={0.06}><h1 className="mt-8 max-w-4xl text-[clamp(4rem,7.2vw,7.5rem)] font-semibold leading-[0.88] tracking-[-0.07em]">Hear the words.<br /><span className="text-white/[0.84]">Analyze the voice.</span><br /><span className="text-[#00d9ff]">Examine the evidence.</span></h1></Reveal>
              <Reveal delay={0.12}><p className="mt-8 max-w-2xl text-lg leading-8 text-white/[0.58] sm:text-xl">VoxVector is an advanced vocal deception analysis engine built to investigate whether measurable patterns in spoken communication contain meaningful evidence associated with deception.</p></Reveal>
