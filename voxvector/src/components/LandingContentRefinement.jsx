...
const REFINEMENT_VERSION = '2026-08-24-header-logo-50-percent-v10'
...
/* Header lockup: 50% allocation on mobile and a restrained professional desktop size. */.vv-header-brand{width:180px!important;max-width:180px!important;min-width:0!important;flex:0 0 180px!important}.vv-header-icon{--vv-header-icon-height:42px;display:block!important;width:var(--vv-header-icon-height)!important;height:var(--vv-header-icon-height)!important;object-fit:contain!important;flex:0 0 auto!important}.vv-header-wordmark{display:block!important;width:calc(100% - var(--vv-header-icon-height) - 10px)!important;height:42px!important;object-fit:contain!important;object-position:left center!important;flex:0 1 auto!important;max-width:none!important;min-width:0!important}
...
@media(max-width:1023px){.vv-header-brand{width:50vw!important;max-width:50vw!important;flex-basis:50vw!important}}@media(max-width:767px){#workflow .vv-console-feature{margin:.8rem auto!important;min-height:190px!important}#workflow .vv-console-feature img{width:92%!important}#workflow .vv-wave-spectrum{gap:2px!important;opacity:.28!important}#workflow .vv-wave-path-a{stroke-width:2!important}#workflow .vv-wave-markers{font-size:6px!important}#workflow h2{font-size:clamp(2rem,9vw,3.2rem)!important;line-height:1.04!important}.vv-header-brand{width:50vw!important;max-width:50vw!important;flex-basis:50vw!important}.vv-header-icon{--vv-header-icon-height:38px}.vv-header-wordmark{height:38px!important}}@media(prefers-reduced-motion:reduce){#workflow .vv-console-feature img,#workflow .vv-wave-path-a,#workflow .vv-wave-path-b,#workflow .vv-wave-spectrum i{animation:none!important}}
`
