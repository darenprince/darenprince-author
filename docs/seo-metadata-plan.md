...
- After major layout or navigation updates (hero, sitemap, new sections), re-run `npm run postprocess:seo` to keep sitemap entries and metadata in sync with the live page structure.
