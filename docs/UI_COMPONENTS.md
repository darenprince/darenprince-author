...
## Heading pattern samples

Use the selector-format heading pattern as the default for dark surfaces:

```html
<h2 class="styledh1 brand-heading">
  <span class="brand-heading__emphasis">Lead line.</span><br />
  <span class="brand-heading__base">Supporting line.</span>
</h2>
```
