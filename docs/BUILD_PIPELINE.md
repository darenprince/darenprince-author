...
>
> **Crown Labs reminder:** `labs/index.html` uses direct favicon assets from `/assets/icons/` plus explicit OG/Twitter metadata with the Crown Labs social image. Keep these references live and committed for GitHub Pages.
