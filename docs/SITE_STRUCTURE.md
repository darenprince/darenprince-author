...
| Path                                                                  | Purpose                             | Notes                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/index.html`                                                         | Public landing page                 | Cinematic hero with a tighter pre-play trailer graphic that expands into the full video frame after playback starts, plus the trailer-first CTA row, testimonials, and contact CTA; loads `js/main.js`, `js/hero-demos.js`, `js/theme-toggle.js`. |
