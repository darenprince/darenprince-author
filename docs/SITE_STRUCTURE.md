...
| `image-index.html`           | Internal image manifest viewer with searchable descriptions, closeable image modal, and pinch-to-zoom responsive grid (mobile supports 4-column compression) | `js/image-index.js`, `scss/components/_viewer.scss`.                                                                                                                       |
