...
| Path                                                                  | Purpose                             | Notes                                                                                                                                                           |
| --------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/labs.html`                                                          | Public landing page                 | Primary Crown Labs landing page with product portfolio, frameworks, live status, and CTA funnels; styled via `assets/labs.css` and powered by `assets/labs.js`. |
| `/index.html`                                                         | Root redirect                       | Lightweight redirect that routes GitHub Pages root traffic to `labs.html`.                                                                                      |
