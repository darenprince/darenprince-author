...
| Path                                                                  | Purpose                             | Notes                                                                                                                                        |
| --------------------------------------------------------------------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `/index.html`                                                         | Public landing page                 | Primary Daren Prince author homepage with books, media, and conversion modules.                                                              |
| `/labs.html`                                                          | Crown Labs landing page             | Crown Labs product portfolio, frameworks, live status, and CTA funnels; styled via `assets/labs.css` and powered by `assets/labs.js`.        |
...
| `/updated-hero.html`                                                  | Updated hero concept gallery        | Standalone hero concept lab with classified, animated hero samples and CTA strategy variants.                                                |
| `/sitemap.html`                                                       | Site index                          | Flex-wrapped navigation cards with grouped brand and tool links.                                                                             |
| `/member/`                                                            | Legacy member shell                 | Currently ungatedtreat as prototype until new auth is wired in.                                                                              |
...
| `leanin.html`                | Lean In workbook                                                                                                                                                 | Standalone HTML with modal credential gate, persistent login, autosave, session archive, print-to-PDF action, zoom-locked mobile layout, and pulldown workbook navigation. |
| `ots.html`                   | Duck Calls one-time secrets                                                                                                                                      | Client-only OneTimeSecret command deck with status, create, and retrieve flows.                                                                                            |
| `image-index.html`           | Internal image manifest viewer with searchable descriptions, closeable image modal, mobile column selector (14), pinch-to-zoom sizing, and copy-only URL actions | `js/image-index.js`, `scss/components/_viewer.scss`.                                                                                                                       |
| `All-heroes-demos.html`      | Experimental hero set                                                                                                                                            | `js/hero-demos.js`, `scss/components/_hero-demos.scss`.                                                                                                                    |
| `updated-hero.html`          | Classified hero concept library                                                                                                                                  | Standalone page with inline animation styles + metadata-complete head for GitHub Pages SEO.                                                                                |
