...
| Path                                                                  | Purpose                             | Notes                                                                                                                                                                                                                                                                                                                                    |
| --------------------------------------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/index.html`                                                         | Public landing page                 | Cinematic hero with a full-bleed mobile “Level Up” title treatment, tightened copy spacing/line-height, and a larger pre-play trailer graphic that expands into the full video frame after playback starts, plus the trailer-first CTA row, testimonials, and contact CTA; loads `js/main.js`, `js/hero-demos.js`, `js/theme-toggle.js`. |
...
| `image-index.html`           | Internal image manifest viewer with searchable descriptions and zoomable grid | `js/image-index.js`, `scss/components/_viewer.scss`.                                                                                                                       |
