...
def _extensible_pcm_wav(sample_rate=16000, frames=800):
    ...
    fmt_payload = struct.pack('<HHIIHHHHI16s', 0xFFFE, channels, sample_rate, byte_rate, block_align, bits, 22, 16, 0x00000001) + bytes.fromhex('01000000100000800000AA00389B71')
