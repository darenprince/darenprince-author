...
>
> **Book landing pages:** When book hero copy changes, update the on-page JSON-LD and rerun `npm run deploy` so GitHub Pages serves fresh metadata and sitemap entries.
