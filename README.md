...
- `leanin.html` — Lean In therapeutic workbook with persistent login, autosave, and local session archive support. Keep the Crown Psychology branding image and Open Graph metadata aligned with `/assets/images/CrownPsych.png` for GitHub Pages deploys.
